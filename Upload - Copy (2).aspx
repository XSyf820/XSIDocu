            ...
            var pdfUrl = '<%= Session["UploadedPdfUrl"] %>';
                ...
                function createDraggableInput(type, left, top) {
                    ...
                    if (type === "signature") {
                        ...
                        signatureBox.className = "draggable-input signature-box";
                ...
                //    $.ajax({
                //        url: 'Upload.aspx/SaveSignatureImage',
                //        type: 'POST',
                //        contentType: 'application/json; charset=utf-8',
                //        dataType: 'json',
                //        data: JSON.stringify({ imageData: signatureImg }),
                ...
                //                    $(activeSignatureBox).attr('data-signature-url', imageUrl); // Set the URL as a data attribute
                //                    $('#signature-pad').modal('hide');
                //                    clearCanvas(); // Clear the canvas after saving
                //                };
                //                img.src = imageUrl; // Set the image source to trigger onload event
                //            } else {
