                                        ...
                                        <div class="col-12 col-sm-9 col-md-9">
                                            ...
                                            <div id="TemplateEdit">
                                                ...
                                                <div id="field-tools" class="mt-3">
                                                    <button id="downloadPdfBtn" class="btn btn-secondary" onclick="updateFieldsToDatabase()">Submit</button>
    ...
    <script>
        ...
        async function downloadPdfWithFields() {
            try {
                ...
                // Iterate through each editable input and handle its positioning and embedding
                ...
                }).get()); // Ensure `.map()` is used with `.get()` to work properly with jQuery
